...
############################################################################################
    field_definitions = [
        ...
        ("desc", "Enter the Description:", return_desc_input),
    ...
    style_entry, stylelabel = field_entries ["style"], field_labels["style"]
    material_entry, materiallabel = field_entries ["material"], field_labels["material"]
    season_entry, seasonlabel = field_entries ["season"], field_labels["season"]
    size_entry, sizelabel = field_entries ["size"], field_labels["size"]
    colour_entry, colourlabel = field_entries ["colour"], field_labels["colour"]
    activewear_entry, activewearlabel = field_entries ["activewear"], field_labels["activewear"]
    condition_entry, conditionlabel = field_entries ["condition"], field_labels["condition"]
    occasion_entry, occasionlabel = field_entries ["occasion"], field_labels["occasion"]
    storagelocation_entry, storagelocationlabel = field_entries ["storagelocation"], field_labels["storagelocation"]
...
#     desc_entry = tk.Entry(scrollable_frame)
#     desc_entry.insert(0, "")
#     desc_entry.bind("<Return>", return_barcode_input)
#     desc_entry.pack(padx=5, pady=5, fill="x")
...
#     season_entry = tk.Entry(scrollable_frame)
#     season_entry.insert(0, "")
#     season_entry.bind("<Return>", return_season_input)
#     season_entry.pack(padx=5, pady=5, fill="x")
